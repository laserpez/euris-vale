                ...
                <ItemTemplate>
                    <table>
                        <tr>
                            ...
                            <td rowspan="3">
                                <asp:Button runat="server" Text="View" ID="btnViewProjectDetails" CommandArgument="<%#: Item.ProjectId %>" CssClass="btn btn-primary btn-sm" OnClick="btnViewProjectDetails_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td>
