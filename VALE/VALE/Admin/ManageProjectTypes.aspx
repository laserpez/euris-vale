                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-lg-10">
                                                <ul class="nav nav-pills">
                                                    <li>
                                                        <h4>
                                                            <asp:Label ID="HeaderName" runat="server" Text="Gestione Tipi Progetti"></asp:Label>
                                                        </h4>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <asp:GridView ID="grdTypes" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <center><div><asp:LinkButton runat="server"  CommandName="ShowType" CommandArgument="<%#: Item.ProjectTypeId %>"> <%#: Item.ProjectTypeName %></asp:LinkButton></div></center>
                                                        </ItemTemplate>
                                                        <HeaderTemplate>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <center>
                                                                <div>
                                                                            <asp:LinkButton runat="server"  CommandName="ShowType" CommandArgument="<%#: Item.ProjectTypeId %>"><span class="label label-primary"><span class="glyphicon glyphicon-eye-open"></span></span></asp:LinkButton>
                                                                            <asp:LinkButton runat="server" CommandName="EditType" Visible='<%# AllowManage(Convert.ToInt32(Eval("ProjectTypeId"))) %>' CommandArgument="<%#: Item.ProjectTypeId %>"><span class="label label-success"><span class="glyphicon glyphicon-pencil"></span></span></asp:LinkButton>
                                                                            <asp:LinkButton runat="server" CommandName="DeleteType" Visible='<%# AllowManage(Convert.ToInt32(Eval("ProjectTypeId"))) %>' CommandArgument="<%#: Item.ProjectTypeId %>"><span class="label label-danger"><span class="glyphicon glyphicon-trash"></span></span></asp:LinkButton>
                                                                        </div>
                                                            </center>
                                                        </ItemTemplate>
                                                        <HeaderTemplate>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <legend>Nuovo Tipo di Progetto</legend>
                            <div class="form-group">
