                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-lg-10">
                                                <ul class="nav nav-pills">
                                                    <li>
                                                        <h4>
                                                            <asp:Label ID="HeaderName" runat="server" Text="Gestione Tipi attività"></asp:Label>
                                                        </h4>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="row" runat="server" id="pnlTypeList">
                                        <div class="col-md-12">
                                            <asp:GridView ID="grdTypes" runat="server" AutoGenerateColumns="False"
                                                ItemType="VALE.Models.ActivityType"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <center><div><asp:LinkButton runat="server"  CommandName="ShowType" CommandArgument="<%#: Item.ActivityTypeId %>"> <%#: Item.ActivityTypeName %></asp:LinkButton></div></center>
                                                        </ItemTemplate>
                                                        <HeaderTemplate>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <center>
                                                                <div>
                                                                    <asp:LinkButton runat="server"  CommandName="ShowType" CommandArgument="<%#: Item.ActivityTypeId %>"><span class="label label-primary"><span class="glyphicon glyphicon-eye-open"></span></span></asp:LinkButton>
                                                                    <asp:LinkButton runat="server" CommandName="EditType" Visible='<%# AllowManage(Convert.ToInt32(Eval("ActivityTypeId"))) %>' CommandArgument="<%#: Item.ActivityTypeId %>"><span class="label label-success"><span class="glyphicon glyphicon-pencil"></span></span></asp:LinkButton>
                                                                    <asp:LinkButton runat="server" CommandName="DeleteType" Visible='<%# AllowManage(Convert.ToInt32(Eval("ActivityTypeId"))) %>' CommandArgument="<%#: Item.ActivityTypeId %>"><span class="label label-danger"><span class="glyphicon glyphicon-trash"></span></span></asp:LinkButton>
                                                                </div>
                                                            </center>
                                                        </ItemTemplate>
                                                        <HeaderTemplate>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <legend>Nuovo Tipo di attività</legend>
                            <div class="form-group">
                                <label class="col-lg-12 control-label">Nome Tipo *</label>
                                <div class="col-lg-10">
                                    <asp:TextBox runat="server" class="form-control input-sm" ID="NameTextBox" />
                                    <asp:RequiredFieldValidator runat="server" ValidationGroup="AddType" ControlToValidate="NameTextBox" CssClass="text-danger" ErrorMessage="Il campo Nome Attività è richiesto." />
                                </div>
                            </div>
                            <div class="form-group">
                                <br />
