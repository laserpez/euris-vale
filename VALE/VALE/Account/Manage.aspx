<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="VALE.Account.Manage" %>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <section id="requestAssociation">
                <h4>Request association</h4>
                <asp:Label runat="server">Here you can send a request to the administrator to become an associated user. </asp:Label><br />
                <asp:Label runat="server">Associated users can create projects, events and personal activities.</asp:Label><br />
                <asp:Button runat="server" ID="btnRequestAssociation" CssClass="btn btn-info" OnClick="btnRequestAssociation_Click" Text="Request association" /><br />
