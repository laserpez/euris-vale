                                ...
                                <div id="PersonalData">
                                    <asp:FormView runat="server" ID="PersonalDataFormView" ItemType="VALE.Models.ApplicationUser" EmptyDataText="Nessun dato presente." SelectMethod="GetUserData">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label runat="server" Text="CV: "></asp:Label><asp:LinkButton runat="server" ID="CVAttachment" CausesValidation="false" Text='<%# Item.CVName %>' OnClick="CVAttachment_Click"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:FormView>
                                </div>
                            </div>
