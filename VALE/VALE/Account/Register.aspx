<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="Register.aspx.cs" Inherits="VALE.Account.Register" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="well bs-component">
                        ...
                        <lu>
                            <li>
                                La password deve essere lunga almeno 6 carattere.
                            </li>
                        </lu>
                        <br />
