                                            ...
                                            <asp:GridView AutoGenerateColumns="false" ID="UsersGridView" runat="server" ItemType="VALE.Models.UserData" DataKeyNames="UserName" AllowPaging="true" PageSize="10" AllowSorting="false" SelectMethod="UsersGridView_GetData" CssClass="table table-striped table-bordered">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            <center><div><asp:Button ID="btnAddUsers" Width="90" Enabled='<%# !IsUserRelated(Eval("UserName").ToString()) || !IsStartedWork(Eval("UserName").ToString()) %>' CssClass='<%#: IsUserRelated(Item.UserName) ? "btn btn-danger btn-xs" : "btn btn-success btn-xs" %>' Text= '<%#: IsUserRelated(Item.UserName) ? "Rimuovi" : "Aggiungi" %>' runat="server" OnClick="btnAddOrRemoveUsers_Click" CommandName="<%# Item.UserName %>" /></div></center>
                                                        </ItemTemplate>
