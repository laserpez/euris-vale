    ...
    <p>
        <asp:UpdatePanel ID="ProjectGrid" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="btn-group">
                    <button type="button" id="btnCurrentView" class="btn btn-primary btn-xs dropdown-toggle" data-toggle="dropdown" runat="server">Sospesi<%--<span class="caret"></span>--%></button>
