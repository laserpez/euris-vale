                        ...
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                <div class="panel-body" style="max-height: 700px; overflow: auto;">
                                    ...
                                    <asp:Label ID="lblAllowDragAndDrop" runat="server" Visible="false" Text="false"></asp:Label>
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body" style="max-height: 170px; overflow: auto;">
                                                    ...
                                                    <asp:GridView ID="grdUsers" runat="server" AllowSorting="true" AutoGenerateColumns="false" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <center><div><asp:LinkButton  runat="server" CommandName="sort" ID="labelRuolo"><span  class="glyphicon glyphicon-cog"></span> Ruolo</asp:LinkButton></div></center>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                ...
                                                <div class="panel-footer">
                                                    <asp:Button ID="btnAddSelectedUsersToGroupButton" CssClass="btn btn-primary btn-xs disabled" runat="server" Text="Aggiungi Selzionati" OnClick="btnAddSelectedUsersToGroupButton_Click" />
                                                </div>
                                            </div>
                                        </div>
                                        <asp:UpdatePanel runat="server">
                                                        ...
                                                        <div class="panel-body" style="max-height: 170px; overflow: auto;">
                                                            <asp:GridView ID="grdGroups" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        ...
                                                                        <HeaderTemplate>
                                                                            <center><div><asp:LinkButton runat="server" CommandArgument="Description" CommandName="sort" ID="labelName"><span  class="glyphicon glyphicon-credit-card"></span> Descrizione</asp:LinkButton></div></center>
                                                                        </HeaderTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        ...
                                                                        <HeaderTemplate>
                                                                            <center><div><asp:LinkButton CommandName="sort" runat="server" ID="labelStartDate"><span  class="glyphicon glyphicon-cog"></span> Azioni</asp:LinkButton></div></center>
                                                                        </HeaderTemplate>
                                                            ...
                                                            <asp:GridView ID="grdGroupUsers" AllowSorting="true" runat="server" AutoGenerateColumns="false"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <HeaderTemplate>
                                                                            <center><div><asp:LinkButton CommandName="sort" runat="server" ID="labelRuolo"><span  class="glyphicon glyphicon-cog"></span> Ruolo</asp:LinkButton></div></center>
                                                                        </HeaderTemplate>
                                                                        <ItemTemplate>
                                                                            <center><div><%# GetRoleName(Item.UserName) %></div></center>
                                                                        </ItemTemplate>
