        ...
        <ContentTemplate>
            ...
            <div class="panel panel-primary" id="pnlPopupUser" style="width: 80%;">
                <div class="panel-heading">
                    <asp:Label ID="TitleModalView" runat="server" Text="Users List"></asp:Label>
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <asp:GridView SelectMethod="GetUsers" ID="UsersList" runat="server" AutoGenerateColumns="false" GridLines="Both" AllowSorting="true"
                                ItemType="VALE.Models.UserData" EmptyDataText="No users" CssClass="table table-striped table-bordered">
                                <Columns>
                                    <asp:BoundField DataField="UserName" HeaderText="User Name" SortExpression="UserName" />
                                    ...
                                    <asp:TemplateField HeaderText="Add">
                                        <ItemTemplate>
                                            <asp:Button runat="server" CausesValidation="false" CommandArgument="<%#: Item.UserName %>" Text="Add" CssClass="btn btn-info btn-sm" ID="btnChooseUser" OnClick="btnChooseUser_Click" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
