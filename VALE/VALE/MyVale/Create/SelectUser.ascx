...
<div class="col-md-10">
    <asp:UpdatePanel ID="SearchProjectPanel" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ItemType="VALE.Models.UserData" AllowPaging="true" PageSize="10" OnPageIndexChanging="lstUsers_PageIndexChanging" DeleteMethod="DeleteUser" AutoGenerateColumns="false" GridLines="Both" AllowSorting="true"
