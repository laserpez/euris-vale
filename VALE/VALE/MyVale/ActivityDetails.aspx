                                                                        ...
                                                                        <ul class="nav nav-pills">
                                                                            <li>
                                                                                <span runat="server" class="badge">
                                                                                    <asp:Label runat="server" ID="lblHoursWorked" CssClass="control-label"><%#: GetHoursWorked() %></asp:Label></span></li>
                                                                        </ul>
                                                                    </div>
                                                                    <div class="navbar-right">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <xyz:HtmlEditorExtender EnableViewState="true" EnableSanitization="false" runat="server" TargetControlID="txtActDescription">
                                        <Toolbar>
                                            <ajaxToolkit:Undo />
                                            <ajaxToolkit:Redo />
                                            <ajaxToolkit:Bold />
