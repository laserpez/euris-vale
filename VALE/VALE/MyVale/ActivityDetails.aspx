...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:FormView runat="server" ID="ActivityDetail" ItemType="VALE.Models.Activity" SelectMethod="GetActivity">
        <ItemTemplate>
            ...
            <br />
            <asp:Label runat="server" CssClass="control-label"><%#: String.Format("From: {0} - To: {1}", Item.StartDate.HasValue ? Item.StartDate.Value.ToShortDateString() : "Non definita", Item.ExpireDate.HasValue ? Item.ExpireDate.Value.ToShortDateString() : "Non definita") %></asp:Label>
            <br />
