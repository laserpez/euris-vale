...
namespace VALE.MyVale
{
    public partial class Projects : System.Web.UI.Page
    {
        ...
        public List<Project> GetOpenProjects()
        {
            ...
            return dbData.Projects.Where(p => p.Status == "open" || p.Status == "suspended").ToList();
        }


        public IQueryable<Project> GetClosedProjects()
        {
            var dbData = new UserOperationsContext();
            return dbData.Projects.Where(p => p.Status == "closed");
        }
        ...
        {
            ViewState["lstProject"] = GetOpenProjects();
        ...
        protected void OpenedProjectList_DataBound(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < OpenedProjectList.Rows.Count; i++)
            {
                ...
                else
                {
                    ...
                    btnAttend.Text = "Work on this project";
                }
            }
        }
