...
var OxOa49b=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOa49b[1],true)[OxOa49b[0]]=function (){if(event[OxOa49b[2]]){alert(element[OxOa49b[3]].cssText);} ;} ;
</script>
